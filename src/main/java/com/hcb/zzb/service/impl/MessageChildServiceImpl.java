...
@Service("messageChildService")
public class MessageChildServiceImpl implements IMessageChildService{
	@Autowired
	private MessageChildMapper messageChildMapper;
	...
	@Override
	public List<MessageChild> selectMessageChildByMessageBaseUuid(String messageBaseUUid) {
		// TODO Auto-generated method stub
		return messageChildMapper.selectMessageChildByMessageBaseUuid(messageBaseUUid);
	}
